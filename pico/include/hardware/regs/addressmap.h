...
#define REG_ALIAS_RW_BITS  (0x0u << 12u) // 0x0000
#define REG_ALIAS_XOR_BITS (0x1u << 12u) // 0x1000
#define REG_ALIAS_SET_BITS (0x2u << 12u) // 0x2000
#define REG_ALIAS_CLR_BITS (0x3u << 12u) // 0x3000
...
#define SRAM_STRIPED_BASE _u(0x20000000) // 264k
#define SRAM_STRIPED_END _u(0x20040000)
#define SRAM4_BASE _u(0x20040000)       // 4k(1)
#define SRAM5_BASE _u(0x20041000)       // 4k(2)
#define SRAM_END _u(0x20042000)
#define SRAM0_BASE _u(0x21000000)  // 64k(1)
#define SRAM1_BASE _u(0x21010000)  // 64k(2)
#define SRAM2_BASE _u(0x21020000)  // 64k(3)
#define SRAM3_BASE _u(0x21030000)  // 63k(4)

// APB Bridge Peripherals[4]
